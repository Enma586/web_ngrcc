  ...
  return (
    ...
    >
      <div className="flex gap-4 md:gap-8 items-center">
        <div className="card-zoom relative w-24 h-24 md:w-32 md:h-32 shrink-0 overflow-hidden bg-[#F0EAD6]">
          <img
            src={post.imageUrl}
            alt={post.title}
        ...
        <div className="space-y-1 md:space-y-2 min-w-0">
          ...
          <h3 className="text-lg md:text-2xl font-serif leading-tight group-hover:text-[#D4AF37] transition-colors duration-300 italic truncate">
            {post.title}
          </h3>
