      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
          <div className="feature-item p-8 md:p-12 border-b md:border-b-0 md:border-r border-black/5 space-y-4 md:space-y-6">
            <span className="text-[10px] uppercase tracking-[0.4em] text-gold font-bold">01</span>
          ...
          <div className="feature-item p-8 md:p-12 border-b md:border-b-0 md:border-r border-black/5 space-y-4 md:space-y-6">
            <span className="text-[10px] uppercase tracking-[0.4em] text-gold font-bold">02</span>
          ...
          <div className="feature-item p-8 md:p-12 space-y-4 md:space-y-6">
            <span className="text-[10px] uppercase tracking-[0.4em] text-gold font-bold">03</span>
