      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="group">
          ...
          <div className="flex gap-3">
            <button type="button" onClick={() => setPostType('post')} className={`flex-1 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest border-2 transition-all duration-300 cursor-pointer ${postType === 'post' ? 'border-gold bg-gold/10 text-charcoal' : 'border-gray-200 bg-white text-gray-400 hover:border-gray-300'}`}>
            ...
            <button type="button" onClick={() => setPostType('evento')} className={`flex-1 py-3 rounded-xl text-[10px] font-bold uppercase tracking-widest border-2 transition-all duration-300 cursor-pointer ${postType === 'evento' ? 'border-gold bg-gold/10 text-charcoal' : 'border-gray-200 bg-white text-gray-400 hover:border-gray-300'}`}>
